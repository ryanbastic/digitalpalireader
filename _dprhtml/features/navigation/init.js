...
export class NavigationTabViewModel {
	constructor() {
		...
		this.navMetaVisible = ko.computed(function _() {
			return NavigationTabViewModel.navPartOptionsEmpty(this.navMeta);
		}, this);
		this.navVolumeVisible = ko.computed(function _() {
			return NavigationTabViewModel.navPartOptionsEmpty(this.navVolume);
		}, this);
		this.navVaggaVisible = ko.computed(function _() {
			return NavigationTabViewModel.navPartOptionsEmpty(this.navVagga);
		}, this);
		this.navSuttaVisible = ko.computed(function _() {
			return NavigationTabViewModel.navPartOptionsEmpty(this.navSutta);
		}, this);
		this.navSectionVisible = ko.computed(function _() {
			return NavigationTabViewModel.navPartOptionsEmpty(this.navSection);
		}, this);
		...
		this.navMetaInfo = ko.computed(function _() {
			return this.computePartInfo(0);
		}, this);
		this.navVolumeInfo = ko.computed(function _() {
			return this.computePartInfo(1);
		}, this);
		this.navVaggaInfo = ko.computed(function _() {
			return this.computePartInfo(2);
		}, this);
		this.navSuttaInfo = ko.computed(function _() {
			return this.computePartInfo(3);
		}, this);
		this.navSectionInfo = ko.computed(function _() {
			return this.computePartInfo(4);
		}, this);
		...
		this.bookmarksInfo = ko.computed(
